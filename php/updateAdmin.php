...
$update = "UPDATE admin SET name = '" . $_POST["Title"] . "', gender = '" . $_POST["Gender"] . "' WHERE uid = '" . $_POST["uID"] . "'";
$result = pg_query($update) or die('Query failed: ' . pg_last_error());

$update = "UPDATE admin SET email = '" . $_POST["Email"] . "', birthday = '" . $_POST["bday"] . "' WHERE uid = '" . $_POST["uID"] . "'";
$result = pg_query($update) or die('Query failed: ' . pg_last_error());
