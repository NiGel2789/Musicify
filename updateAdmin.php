...
<html>
	<head>
		<title>Update A Admin Entry</title>
		<meta charset="utf-8" />
					...
					<div id="main">
						...
						<!-- One -->
							<section id="one">
								<div class="inner">
									<header class="major">
										<h1>Update a Admin Entry</h1>
                                    </header>
                                    <form id="register" method="post" action="./php/updateAdmin.php">    
                                        <label><b>Select a Admin from this dropdown menu:    
                                        </b>    
                                        </label>    
                                        <select name="uID">
                                            <?php
											...
											$query = 'SELECT uid, name FROM admin';
